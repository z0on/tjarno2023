...
The environmental dataset used here (`meta` for sampling locations, `meta.xt` for individual samples, and `rasters` for the whole Baltic Sea) were donwloaded from [Copernicus](https://data.marine.copernicus.eu/products?q=baltic). I took temperature and salinity from [Baltic Sea Physics Reanalysis](https://data.marine.copernicus.eu/product/BALTICSEA_MULTIYEAR_PHY_003_011/download?dataset=cmems_mod_bal_phy_my_P1M-m) and the rest from [Biogeochemistry Reanalysis](https://data.marine.copernicus.eu/product/BALTICSEA_MULTIYEAR_BGC_003_012/download?dataset=cmems_mod_bal_bgc_my_P1M-m). The donloaded `.nc` files were grid-aligned, averaged, and transformed into dataframes using script `baltic.variables.R`. I retained only the variables showing reasonable variation acoss Baltic, and log2-transformed some of them (SDs for those were also calculated for log2-transformed data). The doc with additional info on the variables is `baltic.chemVars.names.docx`. There are two envoronmental datasets for different years: 2014 (in fact, 2013-2015) and 2000 (actually 1999-2001). Samples were collected in 2014. Compare adaptation maps in 2014 and 2000 to see where they had to evolve the most!
